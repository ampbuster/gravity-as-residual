...
| 100 (NEW v3.0.21, REVISED v3.2, USER-CRITIQUED FIVE TIMES) | $F_p$(z) framework OVERSTATED; 'primordial = 99.93%' WRONG; cumulative gives 3.4× Ω_DM but RATIO OVER COSMIC TIME is unaddressed; f_back cannot balance DM; DM→ν decay is 10²¹× too short vs observations | OPEN (v3.2) | v21, calculations/v31_audit_v312final.py, v31_scenario_X.py, v31_all_events_cumulative.py, v31_fback_balance.py, v31_dm_decay_neutrino.py | $F_p$(z) separates primordial (99.93%) vs cumulative (0.07%) DM. **FUNDAMENTAL REVISIONS (v3.2, user-caught FIVE TIMES)**: (a) **'Primordial = 99.93%' is WRONG** (1st catch): uniform DM cannot explain AGC/KKR variation. (b) **Cumulative is NOT just SNe** (2nd catch): including all events gives 3.4× Ω_DM, AGN dominates (10⁴× SN contribution). (c) **DM/baryon ratio over cosmic time** (3rd catch): if DM only accumulates (rate ~10⁴ M_⊙/Mpc³/yr) and doesn't decay (rate 1.8×10⁻³³ M_⊙/Mpc³/yr, 10³³× slower), then DM/baryon ratio should INCREASE rapidly. But observations show roughly CONSTANT ratio (Ω_DM/Ω_b ≈ 5.4 at z=0 and z=1100). (d) **f_back cannot balance DM** (4th catch): required f_back to balance DM accumulation = 3.0×10⁻¹⁵ /s, which is 10⁷⁰× larger than the framework's calibrated value (1.22×10⁻⁸⁵). Increasing f_back by 10⁷⁰× would make DE 10⁷⁰× too large, breaking the 14% DE match. (e) **DM→ν decay is 10²¹× too short vs observations** (5th catch): required half-life for equilibrium is 4×10⁵ yr, but observational lower limits on DM decay are > 10²⁶ yr (10²¹× longer). So DM→ν decay doesn't work. **NET RESULT (v3.2)**: The framework's DM accounting has FIVE problems: (i) 'primordial = 99.93%' is wrong, (ii) cumulative gives 3.4× Ω_DM (close but not exact), (iii) DM/baryon ratio evolution unaddressed, (iv) f_back cannot balance DM without breaking DE, (v) DM→ν decay is 10²¹× too short vs observations. The '5/5 dwarf cases' test cumulative, but the framework doesn't explain why DM/baryon ratio is constant over cosmic time. Possible resolutions (all require new physics): (1) DM-baryon co-creation at high z, (2) two-tier f_back, (3) much slower accumulation (AGN rate much lower), (4) different DM source. STRENGTH: per-event physics robust, all-events integration gives ~Ω_DM. WEAKNESS: framework can't explain constant DM/baryon ratio; f_back calibrated to DE; DM→ν ruled out by 10²¹×. The framework's DM picture is INCOMPLETE. |
