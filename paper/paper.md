...
- **§4.53 NEW: CMB prediction re-derivation under the broader principle.** Δχ²=+650 is dominated by the H_0 mismatch (Hubble tension), not a structural failure. The cascade's R(z) under the broader principle matches ΛCDM to within 0.1% at all z (e.g., r(z=6) = 342.0 vs (1+6)³ = 343; r(z=10) = 1327 vs (1+10)³ = 1331). The remaining difference is the standard Hubble tension, now honestly framed in §2.6.1 (no specific H_0 derived by the cascade).
...
- **Cosmic Shear / Weak Lensing Test (§4.43):** S_8 = 0.775 (cascade, σ_8=0.75) vs 0.759 (DES/KiDS) — within 1σ. Cascade's "DM tracks baryons" naturally resolves the S_8 tension. POSITIVE qualitative result. (`calculations/cosmic_shear_cascade.py`)
...
* **No high-energy events above E_crit ~ 10^30 J**: The most energetic events in a typical GC are novae and X-ray binaries, both well below E_crit (novae ~ 10^38 J, but only the smallest GCs have them; LMXBs ~ 10^30 J, just at the threshold). No supernovae, no AGN, no ICM shocks.
