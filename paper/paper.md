...
- **129 pages** (was 97 in v2.2.1), 650 KB. **17 test categories** (15/17 pass, 2 confounded/inconclusive).
...
*Summary.* **15 of 17 tests pass** (88%), 1 is confounded (HI-DM), 1 is inconclusive (Vflat-morphology). Among the 15 passing tests: 5 are clean real-data passes, 4 are structural (cascade avoids ΛCDM small-scale problems by having no sub-halos), 5 are not discriminative vs ΛCDM (both models predict similar things), 1 is tentative (AGN host DM, confounded by morphology). The cascade's empirical basis is now:
