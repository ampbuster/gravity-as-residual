...
- **KKR 25** (REVISED v2.7.33+, DM-rich dSph, $M_{b}$ = 3×$10^{6}$ M_⊙): an intense historical starburst 1-4 Gyr ago whose $S_{destruction}$ energy remains permanently cached on our brane as a stable gravitational fossil. SIDC's previous $M_{b}$ (3×$10^{9}$) was 1000× too high vs. Makarov 2012; the $M_{dyn}$/$M_{b}$ ~ 1-4 (was 299) is still consistent with dSph typical values.
