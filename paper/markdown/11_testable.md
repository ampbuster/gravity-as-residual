...
| Current mass ($M_{dyn}$) | 7×$10^{5}$ $M_\odot$ | σ_v = 11.7 km/s |
...
2. **Cumulative 2D universe contribution over 12 Gyr:** at formation, 47 Tuc had ~$10^{4}$ O/B stars, each producing a SN at ~$10^{44}$ J. Total SN energy ~ $10^{48}$ J. With SIDC's $f_{\rm back}$ ~ $10^{-85}$, the resulting DM contribution is:
   - E_DM = $10^{48}$ × $10^{-85}$ = $10^{-37}$ J = **5.6×$10^{-85}$ $M_\odot$**
...
6. **Mass loss over 12 Gyr:** dM/dt from 2-body relaxation is ~2×$10^{-6}$ $M_\odot$/yr (negligible). Stellar evolution mass loss is ~30% of initial mass. Total: ~3×$10^{5}$ $M_\odot$ lost, leaving the observed 7×$10^{5}$ $M_\odot$. The 5 known tidal tails (Shipp+ 2021, Ibata+ 2024, Boldrini+ 2024) contain ~0.5% of the cluster mass and are consistent with Galactic tidal stripping + 47 Tuc's complex orbit.
