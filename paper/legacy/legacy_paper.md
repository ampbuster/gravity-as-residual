...
This file merges two sources of historical content:
1. Sections moved from `paper/markdown/03*.md` and `04_predictions.md`
   in v3.1 (DISCARDED mechanisms, superseded derivations, etc.)
2. Sections previously moved from the original `paper.md` (in v3.0.9+)
   including F_p(z) corrections, phase transitions, and v2.7 audits.

Both sources contain the same kind of content: historical trial-and-error,
superseded sections, DISCARDED mechanisms, and self-critique.

---

## Table of Contents

### Part A: From v3.1 cleanup (moved from `paper/markdown/`)
...
### Part B: From original paper.md (moved in v3.0.9+, top-level legacy_paper.md)

#### Part 7: F_p(z) Corrections (v2.7.50-52)
- §3.38: F_p(z) analysis — corrected (v2.7.50, REVISED v2.7.51)
- §3.39: Lessons learned from F_p revision (v2.7.52, meta)

#### Part 8: Smooth F(z) DM Design (v2.7.8+)
- §4.48: Smooth F(z) DM Design (v2.7.8+, supersedes v2.4-v2.7.7)
- §4.49: Bug Fix: The (1+z)^4 Dilution Factor (v2.4)

#### Part 9: v2.7.12-v2.7.29 Additions/Removals/Discards
- Recent Additions, Removals, and Discards (v2.7.12-v2.7.29)

#### Part 10: Research Path to v3.0 (v2.7.59-v2.7.67)
- §3.48-§3.59: Research path to v3.0 (v2.7.59-v2.7.67, summarized)

#### Part 11: v2.7.53-58 Audits
...
# ============================================================
# Part B: From top-level legacy_paper.md (original paper.md v3.0.9+)
# ============================================================
