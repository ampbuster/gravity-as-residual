...
- **144 master table limitations** (159 with L308af-ba), **486 pages**, paper built successfully
...
**Limitations**: **144 master table** (159 with L308af-ba, was 131 v3.5.8, +L308t through +L308az; REVISED)
...
## Open Limitations (79 OPEN, 22 PARTIAL, 2 RESOLVED, 8 CLOSED, 6 NEGATIVE, 7 SPECULATIVE = 124 + 20 L308f-L308ay = 144 in v3.5.9+ A2 master table; +14 L308af-az awaiting master table = 159 total)
...
**Paper**:
- `paper/paper.pdf` (486 pages, 1.52 MB, v3.5.9+ A2)
