...
**Version**: v3.5.9+ A2 (APPROACH A2: α dim-specific: α_2D=1.289, α_4D=1.577; $f_{\rm back}$ → $f_{\rm DE}$,closed)
...
- f_leak = H₀ (NEW A1 principle, post-Friedmann)
