...
- **144 master table limitations** (169 with L308af-bk), **519 pages**, paper built successfully
...
**Limitations**: **144 master table** (169 with L308af-bk, was 131 v3.5.8, +L308t through +L308az; REVISED)
...
**Paper**:
- `paper/paper.pdf` (519 pages, 1.52 MB, v3.5.9+ A2)
