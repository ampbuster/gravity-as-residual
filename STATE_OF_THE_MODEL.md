...
- **L308t**: L26 FULL CLOSURE. $M_{\rm Pl,2D}$ = 2.95 TeV, μ = $8.73 \times 10^{6}$, $M_{\rm Pl,4D}$ = $3.93 \times 10^{23}$, $N_{\rm sub} = 3.86 \times 10^{2}$- **L308u**: WHY $N=12$? Appelquist 2001 + Z_12 bulk + 6D anomaly cancellation
