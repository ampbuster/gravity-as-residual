...
**Current version:** v3.5.9+ A2 (paper) — 479 pages, **144 master table limitations** (157 with L308af-ay in v3.5.9+ A2)
...
**Last updated:** June 22, 2026 (v3.5.9+ A2 ACTIVE: +L308af-ay (13 new limitations), +L308ax (frame-neutral leak naming), +§7.4.42b, +web research audit (L43/L138/L144/L142a negative result), +sweeps 18-98, **157 limitations** (144 master + 13 L308af-ay), **479 pages**, 1.52 MB, **15 parameters** (1+3+2+4+4+1))
...
**v3.5.9+ A2 L308af-ay (USER-DRIVEN, June 22)**: 13 new limitations (L308af-ay), all awaiting master table update. **144 master + 13 L308af-ay = 157 total limitations**, 479 pages, 1.52 MB.
