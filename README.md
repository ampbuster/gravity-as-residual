...
>
> [GitHub repo](https://github.com/ampbuster/gravity-as-residual) · [Paper (PDF, 527 pages, 1.85 MB)](paper/paper.pdf) · [Paper (markdown)](paper/paper.md) · [Master Summary v3.5.9+ A2](paper/SUMMARY_v359_A1.md)
...
### Paper structure (24 markdown files, 527 pages)
...
> ampbuster (2026). *Gravity as Residual: A Thought Experiment on Dimensional Inversion, Annihilation, and the Origin of the Dark Sector.* v3.5.9+ A2, 527 pages.
