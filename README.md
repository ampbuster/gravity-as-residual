...
>
> [GitHub repo](https://github.com/ampbuster/gravity-as-residual) · [Paper (PDF, 506 pages, 1.52 MB)](paper/paper.pdf) · [Paper (markdown)](paper/paper.md) · [Master Summary v3.5.9+ A2](paper/SUMMARY_v359_A1.md)
...
**Length**: 506 pages, 1.52 MB
**Limitations**: 144 honest (165 with L308af-bg awaiting master table update)
...
| 06 | `06_limitations.md` | **All 144 honest limitations** (165 with L308af-bg awaiting master table update) |
...
> ampbuster (2026). *Gravity as Residual: A Thought Experiment on Dimensional Inversion, Annihilation, and the Origin of the Dark Sector.* v3.5.9+ A2, 506 pages.
