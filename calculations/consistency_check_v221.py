...
# 5. Hubble mechanism consistency
print("--- 5. Hubble mechanism ---")
print()
print("  The cascade's final position is Mechanism M (accept the tension):")
print("  - H_0 = 73 km/s/Mpc (4D event's antigravity projection rate)")
print("  - Matches local + Pantheon+ measurements")
print("  - 5.6 km/s/Mpc gap to Planck 67.4 (tension, not resolved)")
print()
print("  Does this depend on 5/27/68? ")
print("  - The H_0 prediction comes from the 4D event's antigravity output,")
print("  - This is the 68% (DE) fraction, NOT the 5/27 split")
print("  - So H_0 = 73 is independent of 5/27 specifically")
print("  - CONSISTENT with the new framing")
print()
