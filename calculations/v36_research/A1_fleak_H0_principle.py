...
γ_4D stays DERIVED (literal time dilation at 4D level). γ_2D = (E_3D/M_Pl,3D)^α = 5.5e44 (literal time dilation at 2D level, per L308x).
...
- γ_2D = (E_3D/M_Pl,3D)^α = 5.5e44 for SN (DERIVED, literal time dilation, L308x)
...
print()
print(f"γ_2D(SN) = (E_SN/M_Pl,3D)^α (per framework §3.23.1, L308x)")
E_SN = 6.25e53
...
print("  - γ_4D and γ_2D are CONSISTENT (both literal time dilation, L308x)")
