...
# Find γ that gives f_back = 10^-85
gamma_required = t_Pl_3 / (T_4D_proper * 1e-85)
print(f"Required γ for f_back = 10^-85:")
...
print("     - Leakage rate: f_back = 10^-85 per 4D-event apparent duration")
print("     - Total leaked: 10^-85 × M_3+1D = 10^-85 × 10^71 = 10^-14 J")
print("     - This is the WHILE-ALIVE gravitational coupling")
print()
print("  3. At 3+1D's death, all energy returns to 4D (f_back_death = 1)")
print()
